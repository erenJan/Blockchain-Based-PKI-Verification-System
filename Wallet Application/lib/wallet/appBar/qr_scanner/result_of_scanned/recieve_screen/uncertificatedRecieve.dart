...
void recieveUncertificated(context,walletAddress,amount){
    ...
    builder: (context){
      return new Container(
        ...
        child: Container(
          ...
          child: Uncertificated(walletAddress,amount)
        )
      );
    }
  );
...
class Uncertificated extends StatefulWidget {
  final walletAddress;
  final amount;
  Uncertificated(this.walletAddress, this.amount, {Key key}) : super(key: key);

  @override
  State<Uncertificated> createState() => _Uncertificated();
}

class _Uncertificated extends State<Uncertificated> {
  int currentView = 0;
  List<Widget> pages;
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Flexible(child: Text("Uncertificated Wallet generated this transaction request",style: TextStyle(color: Colors.white,fontSize: 16,fontWeight: FontWeight.bold),)),
                            Icon(Icons.warning_amber_rounded ,color: Colors.white,size: 60.0,),
              ...
              child: Container(
                ...
                child: Center(
                  child: Row(
                    ...
                    children: [
                      Text("Contiune Transaction",style: TextStyle(color: Colors.white,fontSize: 20),),
                      SizedBox(width: 20,),
